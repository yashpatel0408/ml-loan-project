...
col_logo, col_hist, col_logout = st.columns([4.8, 1.4, 1.4])
...
st.markdown(
    '<div class="section"><div class="section-label">Personal Information</div>',
    unsafe_allow_html=True
)
...
st.markdown(
    '<div class="section"><div class="section-label">Financial Details</div>',
    unsafe_allow_html=True
)
